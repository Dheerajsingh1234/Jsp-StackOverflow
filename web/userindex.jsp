							...
							<tbody>
								...
								<th scope="row"><%=i%></th>
								  <td><pre><div class="profile_img">
                                                                            <span class="prfil-img"><img src="images/2.jpg" alt=""> </span><div class="user-name"><p>name</p><span><%=rs.getString(5)%></span> </div></div><br><br><big><%=rs.getString(2)%></big>  
                                                                                               
                                                                              
                                                                          
                                                                                                
                                                                                                </pre>
                                                                                               <a href="replyform.jsp?id1=<%=rs.getString(6)%>"> <button>Reply</button></a>
                                                                                               <a href="answer.jsp?id=<%=rs.getString(6)%>&id1=<%=usercode%>"><button>All Answers</button></a>
