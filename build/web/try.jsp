                                                                   ...
                                                                   <%
                                                                    ...
                                                                    %>     
                                                                                ...
                                                                                <% 
                                                                                        while(rs3.next())
                                                                                         {
                                                                                              ResultSet rs4=st4.executeQuery("select * from user where code='"+usercode+"'");
                                                                                             //String editorname="";
                                                                                             if(rs4.next())
                                                                                             {
                                                                                                // editorname=rs4.getString(1);
                                                                               ...
                                                                               Editby:  <%=rs4.getString(1)%> edited at: <%=rs.getString(5)%>
                                                                               user:  <%=rs2.getString(1)%>  reply at: <%=rs.getString(5)%></pre>
                                                                                                                                   
                                                                                                                                            
                                                                                                    <input type="button" onclick="location.href='editanswerform.jsp?id=<%=questioncode%>&id1=<%=rs1.getString(4)%>';" value="Edit"/></a> <input type="button" onclick="location.href='shareanswer.jsp';" value="share" />
                                                                                                         <%
                                                                                                                if(rs1.getString(2).equals(questioncode))
                                                                                                                {

                                                                                                            %> 
                                                                                                            <input type="button" onclick="location.href='deleteanswer.jsp?id=<%=questioncode%>&id1=<%=usercode%>';" value="delete" />
