...
<!--//Metis Menu -->
 <style>
        ...
        .MultiCheckBoxDetail>div>div:nth-child(l) {
							...
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
								<div class="profile_img">	
									<span class="prfil-img"><img src="images/2.jpg" alt=""> </span>
                                                                        <div class="user-name">
                                                                        <%
                                                                                ResultSet rs3= st1.executeQuery("select * from user where Email='"+email+"'");
                                                                            {
                                                                                    if(rs3.next())
                                                                                      {
                                                                          %>
				...
				<div class="forms">
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title">
							<h4>you must be login to ask a new question :</h4>
						</div>
						<div class="form-body">
							<form method="post" action="addquestion.jsp"> 
							<div class="form-group"> <label >Title</label> <input type="text" class="form-control" name="title" placeholder="eg.which language is use for cloud computing"> </div> 
							 
                                                        <div class="form-group"><label >catagory Discription</label><div ><textarea name="discription" id="txtarea1" cols="50" rows="4" class="form-control1"></textarea></div>
								</div>
                                                           ...
                                                           <%
                                                            ...
                                                            {     String cat=rs.getString(2); 
                                                              ...
                                                              <%
                                                                ...
                                                                <div class="form-body" >
                                                                    <textarea name="cat1" id="div1"></textarea>
                                                                 </div>
                                                                <div class="button">
...
<%
         ...
         {
                response.sendRedirect("userlogin.jsp?emailerradd=1");
          }    
   %>       