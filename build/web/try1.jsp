...
<%
    ...
    if(email!=null || session.getAttribute(email)!=null)
    {
      ...
      try
      {
        ...
        out.println(questioncode);
        out.println(usercode);
        out.println(editcode);
                                                                    ...
                                                                    %>     
                                                                                ...
                                                                                <tr>
                                                                                    <td><pre><div class="profile_img">	
                                                                                            <span class="prfil-img"><img src="images/2.jpg" alt=""> </span><div class="user-name"><p><%=rs2.getString(1)%></p><span><%=rs.getString(5)%></span> </div></div><br><br><big><%=rs1.getString(1)%></big>  
