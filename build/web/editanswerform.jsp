...
<%
    ...
    if(email!=null || session.getAttribute(email)!=null)
    {
      try
      {
        ...
        String replycode=request.getParameter("id1");
       // out.print(usercode);
%>  
<html>
<head>
			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="panel-body widget-shadow">
                                                ...
                                                <form method="post" action="editanswer.jsp?id=<%=questioncode%>">
                                                
                                                          <%
                                                                ResultSet rs= st.executeQuery("select * from question where code='"+questioncode+"'");
                                                               ResultSet rs1= st1.executeQuery("select * from replytable where Replycode='"+replycode+"'");
                                                                   ...
                                                                   <%
                                                                    ...
                                                                    %>     
                                                                                    ...
                                                                                    <pre><%=rs1.getString(1)%>                   
                                                                                                  ...
                                                                                                  asked at: <%=rs.getString(5)%></pre>                                 
                                                                                                     <label for="story"> your answer:</label>

                                                                                        <textarea id="story" name="answer"
                                                                                                  rows="5" cols="33">
